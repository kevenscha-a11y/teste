  ...
  return (
    ...
    >
      <Link href={`/course/${course.id}`} className="block h-full outline-none">
        <Card className="h-full overflow-hidden bg-card border-border/50 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 group cursor-pointer flex flex-col group rounded-2xl" data-testid={`card-course-${course.id}`}>
